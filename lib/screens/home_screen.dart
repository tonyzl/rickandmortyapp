  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      body: SizedBox(
        ...
        child: apiProvider.characters.isNotEmpty ? CharacterList(
          ...
          child: Card(
            child: Column(
              children: [
                Hero(
                  tag: character.id!, 
                  child: FadeInImage(placeholder:const AssetImage("assets/images/portal.gif"), image: NetworkImage(character.image!)),),
                Text(
                  character.name!,
